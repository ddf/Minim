/**
  * This sketch demonstrates how to use the <code>getMaxLabel</code> method of a <code>FloatControl</code> object.
  ...
  * they can be set to and this value has an associated <code>String</code> label, which is what is returned by the 
  * <code>getMaxLabel</code> method.
  */
...
void draw()
{
  ...
  {
    text("The gain's maximum value label is " + out.gain().getMaxLabel() + ".", 5, 15);
  }
  else
  {
