/**
  * This sketch demonstrates how to use the <code>getMinimum</code> method of a <code>FloatControl</code> object.
  ...
  * is used for sending audio to, or receiving audio from, the audio system. Float controls have a minimum value that 
  * they can be set to, which is what is returned by the <code>getMinimum</code> method.
  */
...
void draw()
{
  ...
  {
    text("The gain has a minimum value of " + out.gain().getMinimum() + ".", 5, 15);
  }
  else
  {
